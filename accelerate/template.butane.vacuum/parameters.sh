...
pert_equi_result="$HOME/study/noneq.msm/accelerate/equi.systems/water.butane.e0.5.module.rf.tab/"
...
pert_taup=2.0			# ps
pert_rescale=2.0		# ps
pert_ele_rescale_start=0.1	# nm
pert_ele_rescale_end=0.4	# nm
pert_vdw_rescale_start=0.3	# nm
pert_vdw_rescale_end=0.6	# nm
