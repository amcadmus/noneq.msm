...
do
    ...
    cd $my_dir
    rm -f run.log
    ../../tools/potential/tab.coulomb --scale $pert_rescale --scale-ele-start 1000 --scale-ele-end 1001 --scale-vdw-start $pert_vdw_rescale_start --scale-vdw-end $pert_vdw_rescale_end --rc $pert_rcut --r-smooth $pert_rsmooth --erf $pert_erf -o table.xvg
    ../../tools/potential/tab.coulomb --scale $pert_rescale --scale-ele-start 1000 --scale-ele-end 1001 --scale-vdw-start $pert_vdw_rescale_start --scale-vdw-end $pert_vdw_rescale_end --rc $pert_rcut --r-smooth $pert_rsmooth --erf $pert_erf -o tablep.xvg
    if [ $? -ne 0 ]; then
