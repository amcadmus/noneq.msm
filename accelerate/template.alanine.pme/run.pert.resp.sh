...
do
    ...
    ../../tools/parse.top/rescale.param.cap.resp -f topol.top -b $pert_rescale -a $pert_rescale -d $pert_rescale --scal-cmap $pert_rescale --cap-period-bond $pert_bond_T_cap --cap-period-angle $pert_angle_T_cap -o out.top
