...
\end{tabular}
\caption{One-dimensional dynamics. Convergence results for the modified
...
\begin{figure}[tphb]
  \centering
    ...
    \caption{One-dimensional dynamics. Optimized potential $V^{(3)}$ with
...
\begin{figure}[tphb]
  \centering
    \includegraphics[width=9.0cm]{./fig/pot_2d_1_0_0.eps}
