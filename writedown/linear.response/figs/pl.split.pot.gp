...
0.0 * 1./sqrt(2*pi*sigma2) * exp(-x**2/(2.*sigma2)) + 4*x**2 ls 1 t'{/Symbol e}  = 0.0',\
1.0 * 1./sqrt(2*pi*sigma2) * exp(-x**2/(2.*sigma2)) + 4*x**2 ls 2 t'{/Symbol e}  = 1.0',\
2.0 * 1./sqrt(2*pi*sigma2) * exp(-x**2/(2.*sigma2)) + 4*x**2 ls 3 t'{/Symbol e}  = 2.0'
