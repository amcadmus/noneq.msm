...
set out 'fig-split-str2-simple.eps'
...
spl 'split.warm020.str2.0.nst1e10.noneq/indicator.vx.00020.00.out' u 1:2:(-$3) not
...
spl 'split.warm020.str2.0.nst1e09.ref0.0.resp.order1/indicator.resp.vx.00020.00.out' u 1:2:(-$3) not
...
set origin 0.75, 0.0
set xlabel '(d)'
set title 't=20 ps, resp. n=1, ref=1.0'
# set title 't=20 ps, resp. ref F@_e^{max}=1.0'
