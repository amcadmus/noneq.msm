...
\begin{align}\label{eqn:G0}
  ...
  \frac 1\sigma
  \int_0^\tau
  M_j(\eta)\,\vect D(\vect X_\eta)\cdot\dd\vect W_\eta\\\label{eqn:H00}
  H_{00}[\vect X_\eta]
  =&\,
  \frac 1{\sigma}
  \int_0^\tau
  M_j(\eta)\,M_k(\eta)\,\vect D^2(\vect X_\eta)\cdot\dd \eta
\end{align}
...
\begin{align}\label{eqn:expan-ratio-1}
  ...
  \frac12  
  \sum_{j,k=1}^\infty
  \Delta s_j^{i-1}\Delta s_k^{i-1}G_j[\vect X_s]G_k[\vect X_s]
  +
